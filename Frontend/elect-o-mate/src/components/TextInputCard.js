...
// const TextInputCard = ({ onSendMessage, isSending }) => {
...
//   return (
//     <div className='shadow-full  border-none'>
...
//           type='submit'
//           disabled={isSending}
//           className='scale- font-semibold transition duration-300 ease-in-out transform hover:scale-110 text-xl'
//           variant='contained'
//           style={{
